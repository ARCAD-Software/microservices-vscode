...
To proceed with the installation, please refer to the corresponding <a href="ARCAD-TMS_26.2_A4_Installation~Guide.pdf" target="_blank">Server Installation Guide</a>, which contains detailed instructions to help you install and set up the server.
